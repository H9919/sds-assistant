...
<svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
    ...
    <!-- Ratings -->
    <text x="87" y="105" class="rating" fill="white">""" + str(health) + """</text>
    <text x="150" y="90" class="rating" fill="white">""" + str(fire) + """</text>
    <text x="213" y="105" class="rating" fill="black">""" + str(reactivity) + """</text>
    <text x="150" y="210" class="rating" fill="black">""" + str(special or '') + """</text>
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex space-x-2">
                            <button onclick="generateStickerForProduct('${result.product_name}')" class="text-blue-600 hover:text-blue-800 text-sm">
                                <i class="fas fa-tag mr-1"></i># app.py - Complete SDS Assistant Web Application (FIXED)
import os
from flask import Flask, render_template_string, request, jsonify, send_file, session
import sqlite3
import hashlib
...
if __name__ == '__main__':
    ...
    print()
    app.run(debug=False, host='0.0.0.0', port=port)# app.py - Complete SDS Assistant Web Application (FIXED)
import os
from flask import Flask, render_template_string, request, jsonify, send_file, session
import sqlite3
import hashlib
